...
@section('title', 'Add New Car - Admin Panel')
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.cars.store') }}" enctype="multipart/form-data" id="createCarForm">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="4" placeholder="Describe the car, its features, condition, etc.">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" id="createCarBtn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (createCarForm && createCarBtn) {
        createCarForm.addEventListener('submit', function(e) {
            // Add loading state to the button
            createCarBtn.disabled = true;
            createCarBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Adding Car...';
